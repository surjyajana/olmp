        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form method="post" id="meta_form" action="{{ url('admin/brand/update') }}" enctype="multipart/form-data">
                        
                        @csrf
                        <input type="hidden" name="edit_id" value="{{ $brand->id }}">
                        ...
                        <div class="row" style="display: flex; justify-content: center">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control banner-input only_character" id="brand_name" placeholder="Enter brand name" name="brand_name" value="{{ $brand->brand_name }}" data-validation-engine=" validate[required]" data-errormessage-value-missing="Sub category name is required" data-prompt-position="topLeft" maxlength="30">
                        ...
                        <div class="row" style="display: flex; justify-content: center">
                            <div class="form-group col-md-12" style="display: flex; justify-content: center">
                                <a class="btn btn-info-back float-right mr-1" href="{{url('admin/brand/list')}}">Back to List</a>
