        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form method="post" id="meta_form" action="{{ url('admin/brand/store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row" style="display: flex; justify-content: center">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control banner-input only_character" id="brand_name" placeholder="Enter brand name" name="brand_name" value="{{ old('sub_category_name') }}" data-validation-engine=" validate[required]" data-errormessage-value-missing="Sub category name is required" data-prompt-position="topLeft" maxlength="30">
