      ...
      <div class="row h-100 align-items-center">
        <div class="col-sm-12 col-md-5 mx-auto ">
          <div class="form-container">
            ...
            <form id="sign_in" method="POST" action="{{ url('save-reset-password') }}">
                @csrf
                ...
                @endif
              <input type="hidden" id="eid" name="eid" value="{{ $user_id }}">
              <div class="form-group">
                <label for="password">New password</label>
                <input type="password" class="form-control" id="new_password" name="new_password" placeholder="Enter new password" autocomplete="off" maxlength="20">
              ...
              <div class="form-group">
                ...
                <input type="password" class="form-control" id="confirm_password" name="confirm_password" placeholder="Enter confirm password" autocomplete="off" maxlength="20">
              ...
              <button type="submit" class="btn  mt-1">Forgot Password</button>
