...
@include('user/layouts/navigation/dashboardLeftmenu')
            ...
            <input class="form-control input-md" name="Title" placeholder="Ad title" type="text">
            </div>
            ...
            <span class="tg-radio">
            <input id="tg-sameuser" type="radio" name="ad_post_type" value="sell" checked>
            <label for="tg-sameuser">Sell</label>
            </span>
            <span class="tg-radio">
            <input id="tg-someoneelse" type="radio" name="ad_post_type" value="rent">
